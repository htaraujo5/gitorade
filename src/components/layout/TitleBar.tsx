...
/**
 * Fork-style chrome: menus · centered app name · feedback + window controls.
 */
export function TitleBar({ onFeedback }: { onFeedback: () => void }) {
  ...
  return (
    <div className="grid h-10 shrink-0 grid-cols-[1fr_auto_1fr] items-center border-b border-[#2d3139] bg-[#1a1d24]">
      ...
      >
        <div
          className="pointer-events-none flex select-none items-center justify-center rounded-md border border-[#2d3139] bg-[#12141a] px-5 py-1.5"
          data-tauri-drag-region
        >
